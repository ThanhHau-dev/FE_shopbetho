...
document.addEventListener("DOMContentLoaded", function () {
  const toggles = document.querySelectorAll(
    ".header__menu__2__dropdow > a.nav-link"
  );
...
const dropdownOpen = document.querySelector(
  ".header__menu__mobile__1__nav__dropdow"
);

const dropdownBtns = document.querySelectorAll(
  ".Menu__sidebar__mobile__nav__dropdow__btn"
);
const dropdownContents = document.querySelectorAll(
  ".Menu__sidebar__mobile__nav__dropdow__content"
);
...
const dropdownBtnssidebar = document.querySelectorAll(
  ".footer__3__mobile__dropdow__btn"
);
const dropdownContentssidebar = document.querySelectorAll(
  ".footer__3__mobile__dropdow__content"
);
...
ScrollReveal().reveal(".col-lg-6", {
  ...
  // Cho phép chạy lại khi cuộn lên
